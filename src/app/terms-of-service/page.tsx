  ...
  return (
    <div className="p-6 rounded-md shadow">
      ...
      <section>
        ...
        <p>
          ...
          <ul className="list-disc list-inside">
            ...
            <li><strong>Service</strong> refers to
              the Website.</li>
            <li><strong>Terms and Conditions</strong> (also referred
              to as Terms) mean these Terms and Conditions that
              form the entire agreement between You and the
              Company regarding the use of the Service.</li>
            <li><strong>This Terms and Conditions</strong> agreement has been created
      ...
      <section>
        ...
        <p>
          The laws of the State of Maharashtra and India,
